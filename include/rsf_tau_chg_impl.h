#ifndef RSF_TAU_CHG_IMPL_H_
#define RSF_TAU_CHG_IMPL_H_
...
class RsfTauChgImpl : public RsfTauFixImpl
{
public:
    RsfTauChgImpl();

    RsfTauChgImpl(double a, double b, double Dc, double alpha);
    ...
    RsfTauChgImpl(const RsfTauChgImpl& rsf);

    RsfTauChgImpl& operator=(const RsfTauChgImpl& rsf);
