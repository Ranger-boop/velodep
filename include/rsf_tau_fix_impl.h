#ifndef RSF_TAU_FIX_IMPL_H_
#define RSF_TAU_FIX_IMPL_H_
...
public:
    ...
    RsfTauFixImpl(double a, double b, double Dc, double alpha);
    ...
    RsfTauFixImpl(const RsfTauFixImpl& rsf);

    RsfTauFixImpl& operator=(const RsfTauFixImpl& rsf);
